...
// ----------------------------------
//
//	composites the waypoint list and any active popup into a single string;
...
//
// ----------------------------------
func renderWaypointInteractiveUIView(m *WaypointInteractiveModel) string {
	if m.ShowPopUp.Load() {
		...
		layers := []*lipgloss.Layer{
			lipgloss.NewLayer(m.WaypointInfoList.View()),
	...
	return m.WaypointInfoList.View()
}
