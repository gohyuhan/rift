...
var zH_HANT = LanguageMapping{
	...
	SkippingDueToCwdErr:      "rift：無法取得目前工作目錄，符文命令已略過",
	...
	RuneCommandsInvalidDueToShellBuildInCommand: "偵測到一個或多個符文使用了 Shell 內建命令（如 cd、export、alias），這些命令在子行程中無法修改父 Shell 狀態，在 rift 符文中無效。",
